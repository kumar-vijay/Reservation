...
// date: 2015/05/22 14:06:14
  ...
  'cache_dir' => '/home/vijay/sites/reservation/cache/reservation/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/vijay/sites/reservation/apps/reservation/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/vijay/sites/reservation/cache/reservation/prod/template',
  'lifetime' => 86400,
  'prefix' => '/home/vijay/sites/reservation/apps/reservation/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    array (
      ...
      'port' => 465,
      'encryption' => 'ssl',
      'username' => 'sumit.pachouri@xceedance.com',
      'password' => 'shubham.neha',
    ),
  ),
))));
