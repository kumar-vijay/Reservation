$(document).ready(function (e) {
    ...
    var createSectionCodeOption = function (data) {
        var selectBox = '<option value="0">--Select--</option>';
        var tobeEntered = true;
        for (var i = 0; i < data.length; i += 1) {
            if (data[i].SectionCode == 'To Be Entered') {
                tobeEntered = false;
            }
    ...
    var createProfitCodeOption = function (data) {
        ...
        var tobeEntered = true;
        for (var i = 0; i < data.length; i += 1) {
            if (data[i].ProfitCodeName == 'To Be Entered') {
                tobeEntered = false;
            }
    ...
    $('#editprofitcode_master').change(function (ev) {
        var productLineType = $('#productline_master').val();
        $('#editisccode').val("");
    ...
    var getMasterISOCode = function () {
        var ProfitCodeId = $('#editprofitcode_master').val();
        if (ProfitCodeId) {
            $('#editisccode').prop('disabled', false);
            var dataObj = {
                'header': {
