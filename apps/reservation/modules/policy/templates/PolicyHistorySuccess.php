<div id="content" class="view">
    <div class="breadcrumbs group"> 
        <ul id="breadcrumb">
            ...
            <li class="selected">Policy History</li>
        </ul>
        <a href="/policy/PolicyList" id="back"></a>
    </div>
    <div class="container">
        <ul class="tabbed-menu">
            <li><a href="/policy/EditPolicyNumber?policyId=<?php echo $policyId; ?>">Edit Policy Number Details</a></li>
            <li class="active"><a href="/policy/PolicyHistory?policyId=<?php echo $policyId; ?>">History</a></li>
        </ul>   
        <div class="dates">
                    ...
                    <div class="content" style="display: block;">
                        <table cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="30%" style="word-wrap: break-word; word-break: break-all;white-space: normal;"><?php echo $result['InsuredName']; ?></td>
                                <td width="30%" style="word-wrap: break-word; word-break: break-all;white-space: normal;"><?php echo $result['NewInsuredName']; ?></td>
                            </tr>
                            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td width="30%"><?php echo $result['New_ProductLine']; ?></td>
                            </tr>
                            <?php } ?>
