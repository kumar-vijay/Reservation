...
class AmendmentExport {
    ...
    public function InsertAmendmentDataIntoTempTable() {
        ...
        $query = "Insert into [#Temp](
                        ...
                        ASV.UnderwriterName AS UnderwriterName, ASV.ProductLine AS ProductLine, ASV.ProductLineSubType AS ProductLineSubType, ASV.SectionCode AS SectionCode, ASV.ProfitCode AS ProfitCode,ASV.Status AS CurrentStatus,CONVERT(INT, CONVERT(DATETIME,ASV.EffectiveDate))+2 AS EffectiveDate,CONVERT(INT, CONVERT(DATETIME,ASV.ExpiryDate))+2 AS ExpiryDate,CONVERT(INT,CONVERT(DATETIME,ASV.ProcessDate))+2 AS ProcessDate,CONVERT(INT,CONVERT(DATETIME,ASV.BindDate))+2 AS BindDate,ASV.Renewable AS Renewable,
                        ...
                        left join
                           (select s.id sid, 
							...
							ASV.SubmissionId in (select id from #Temp)
