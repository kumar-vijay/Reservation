                ...
                <div class="content" style="display: block;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="22%">
                               <input type="text" name="editamendmentDuckSubmissionNumber" id="editamendmentDuckSubmissionNumber" class="listbox-small" value="<?php echo $fetchData['submissionRow'][0]['DuckSubmissionNumber']; ?>" />
                            </td>
                            <td width="12%"></td>
                            <td width="22%"></td>
                            <td width="12%"></td>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <select name="productline_master" id="productline_master" class="listbox-small endowselect">
                                        ...
                                        <?php foreach ($data['productLine'] as $productLineValue) { ?>
                                            <option value="<?php echo $productLineValue['Id']; ?>" 
                                                ...
                                                ?>><?php echo $productLineValue['LOBName']; ?>
                                            </option>
                                    <?php } ?>
                                    </select>
                                <?php } else { ?>
                                    <input type="text" name="editamendmentproductline" id="productline" class="listbox-small" readonly/>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="editamendmentprimarystatus"  id="primary_status" class="listbox-small">
                                    <option value="0">-- Select --</option>
                                    <?php
                            ...
                            <td>
                                ...
                                <input type="hidden" name="hiddenexpirydate" value="<?php echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['ExpiryDate'])); ?>" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="editamendmentexchangeRate" id="editamendmentexchangeRate" value="<?php echo trim($fetchData['submissionRow'][0]['ExchangeRate']); ?>" class="txtbox-small"/>
                            </td>
                            <td width="12%">Exchange Rate as on<span style="color: red;"> *</span></td>
                            <td width="22%">
                                <input type="text" name="editamendmentexchangeRateDate" id="editamendmentexchangeRateDate" value="<?php if(!empty($fetchData['submissionRow'][0]['ExchangeDate'])){ echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['ExchangeDate']));} else { echo "";} ?>" class="txtbox-small" readonly />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="22%">
                                <div style="position: relative;">
                                    <input type="text" name="editamendmentinsuredname" id="editamendmentinsuredname"  value="<?php echo $fetchData['insuredName']; ?>" class="txtbox-small"/>
                            ...
                            <td colspan="2" rowspan="6" style="padding:5px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="dba_table_data">
                                    <tr>
                                        ...
                                        <td>
                                            <select id="editamendmentinsuredContactPerson" name="editamendmentinsuredContactPerson"  class="listbox-small mailingaddress" disabled>
                                                <option value="">-- Select --</option>
                                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="editamendmentinsuredContactPersonEmail" name="editamendmentinsuredContactPersonEmail" value="<?php echo $fetchData['insuredContactPersonDetails']['Email']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Contact Person's Number(O)</td>
                                        <td> 
                                            <input type="text" id="editamendmentinsuredContactPersonNumber" name="editamendmentinsuredContactPersonNumber" value="<?php echo $fetchData['insuredContactPersonDetails']['PhoneNumber']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Contact Person's Mobile</td>
                                        <td> 
                                            <input type="text" id="editamendmentinsuredContactPersonMobile" name="editamendmentinsuredContactPersonMobile" value="<?php echo $fetchData['insuredContactPersonDetails']['MobileNumber']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Submission Date</td>
                                        <td> <input type="text" name="editamendmentinsuredSubmissionDate" id='editamendmentinsuredSubmissionDate' value="<?php if(!empty($fetchData['submissionRow'][0]['InsuredSubmissionDate']) && $fetchData['submissionRow'][0]['InsuredSubmissionDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['InsuredSubmissionDate']));} elseif($fetchData['submissionRow'][0]['InsuredSubmissionDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";} else {echo "";} ?>" class="txtbox-small mailingaddress" readonly/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Quote Due Date</td>
                                        <td> 
                                            <input type="text" name="editamendmentinsuredQuoteDueDate" id="editamendmentinsuredQuoteDueDate" value="<?php if(!empty($fetchData['submissionRow'][0]['InsuredQuoteDueDate']) && $fetchData['submissionRow'][0]['InsuredQuoteDueDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['InsuredQuoteDueDate']));} elseif($fetchData['submissionRow'][0]['InsuredQuoteDueDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";}else {echo "";}  ?>" class="txtbox-small mailingaddress" readonly/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="editamendmentsubmissiontypeidrntifier" class="listbox-small">
                                    <option value="0">--Select--</option>
                                    <?php
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="project_street_address" id="project_street_address" value="<?php echo trim($fetchData['submissionRow'][0]['ProjectAddress']); ?>" class="listbox-small project" />
                            </td>
                            <td>Bid Situation</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>Risk Profile</td>
                            <td>
                                <textarea name="editamendmentriskProfile" id="editamendmentriskProfile" maxlength="150" class="listbox-small"><?php echo trim($fetchData['submissionRow'][0]['RiskProfile']);?></textarea>
                            </td>
                        </tr>
                        <tr>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="22%">
                            <input type="text" id="retailBrokerName" name="retailBrokerName" value="<?php echo $fetchData['submissionRow'][0]['RetailBrokerName']; ?>"  class="listbox-small" />
                        </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="editamendment_broker_contact_person_email" id="editamendment_broker_contact_person_email"  class="listbox-small" readonly/>
                            </td>
                            <td width="12%">Broker Contact Person’s Number(O)</td>
                            <td colspan="3">
                                <input type="text" name="editamendment_borker_contact_peson_number" id="editamendment_borker_contact_peson_number"  class="listbox-small" readonly/>
                            </td>
                        </tr>
                        <tr>
                            <td>Broker Contact Person Mobile</td>
                            <td> 
                                <input type="text" name="editamendment_borker_contact_peson_mobile" id="editamendment_borker_contact_peson_mobile"  class="listbox-small" readonly />
                            </td>
                            <td>Broker Code</td>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="22%">
                                <input type="text" name="processdate" id="processdate" class="date txtbox-small" value="<?php if (!empty($fetchData['submissionRow'][0]['ProcessDate'])) { echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['ProcessDate']));} else { echo "";} ?>" disabled readonly />
                            </td>
                        </tr>
                    </table>
                </div>
...
<!--                                    <td width="14%">&nbsp;</td>-->
                                    ...
                                    <?php  if(trim($fetchData['submissionRow'][0]['PremiunType'])=='AP'){ $selectedAP = 'checked="checked"'; }else{ $selectedAP = '';} ?>
                                        AP(Additional Premium)<input type="radio" value="AP" id="premiumType" class="ptype" name="premiumType" <?php echo $selectedAP; ?> />
                                    </td>
<!--                                    <td width="15%">&nbsp;</td>-->
                                     <td width="12%">
                                    <?php if(trim($fetchData['submissionRow'][0]['PremiunType'])=='RP'){ $selectedRP = "checked='checked'"; }else{ $selectedRP = '';} ?>
                                        RP(Return Premium)<input type="radio" value="RP" id="premiumType" class="ptype" name="premiumType" <?php echo $selectedRP; ?> />
                                    </td>
                                    <td width="22%">&nbsp;</td>
                                    <td width="22%">&nbsp;</td>
                                   <td width="22%">&nbsp;</td>
<!--                             </tr>
                        ...
                        <tr>
                            ...
                            <td width="22%" id="gross_premium_value"> 
                                <input type="text" name="gross_premium_text" id="gross_premium" class="txtbox-small statusDetails" value="<?php if (trim($fetchData['submissionRow'][0]['PremiumInLocalCurrency']) == '-1' || trim($fetchData['submissionRow'][0]['PremiumInLocalCurrency']) == '-2') {
                                                echo '';
                                            } else {
                                ...
                                <input type="hidden" name="hidgross_premium_yes" id="hidgross_premium_yes" value="<?php echo trim($fetchData['submissionRow'][0]['IsPremium']);?>">
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="display:none;" id="limit_values">
                                <select name="limit_select" id="limit_select" disabled class="listbox-small statusDetails">
                                    <option value="0" <?php
                                if ($fetchData['submissionRow'][0]['IsAttachmentPoint'] == '') {
                                    echo "selected";
                                }
                                ?>>-- Select --</option>
                                    <option value="-1" <?php
                        ...
                        <tr>
                           ...
                           <td width="12%">Attachment Point in Local Currency<input type="checkbox" name= "yesAttachment" id="yesAttachment" class="ct4 statusDetails" value="Y" <?php
                            ...
                            <td>
                                <input type="text" name="editamendmentattachmentlocalcurrency" id="editamendmentattachmentlocalcurrency" value="<?php echo trim($fetchData['submissionRow'][0]['AttachmentPointInUSD']); ?>" class="statusDetails" readonly/>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="12%">Bind Date
                                ...
                                <input class="ct4" type="checkbox" name= "yesBinddate" id="yesBinddate" value="Y" onclick="return false" <?php echo $selectedBindcheck; ?>  />
                            </td>
                            <td width="22%">
                                <?php  $validDate = date('Y-m-d', strtotime('-10 years')); ?>
                                <input type="text" class="txtbox-small" name="editamendmentbinddate" id="editamendmentbinddate" value="<?php if (!empty($fetchData['submissionRow'][0]['BindDate']) && date("Y-m-d", strtotime($fetchData['submissionRow'][0]['BindDate'])) > $validDate) { echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['BindDate']));} else { echo "";} ?>" readonly="readonly"/>
                            </td>
                            ...
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentdateofrenewal" id="editamendmentdateofrenewal" value="<?php $dateofrenewal = date("m/d/Y", strtotime($fetchData['submissionRow'][0]['DateofRenewal'])); if (!empty($dateofrenewal) && $dateofrenewal !='1970-01-01') { echo date("m/d/Y", strtotime($fetchData['submissionRow'][0]['DateofRenewal']));} else { echo "";} ?>" readonly />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="22%"> 
                                <input type="text" class="txtbox-small ui-autocomplete-input" value="<?php echo $fetchData['submissionRow'][0]['ClassCode']; ?>" id="editamendmentsubClass" name="editamendmentsubClass" <?php if($fetchData['submissionRow'][0]['ClassNameLookupId']<1){?>readonly="readonly"<?php }?> autocomplete="off" maxlength="5">
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentpolicyNumber" id="editamendmentpolicyNumber" value="<?php echo trim($fetchData['submissionRow'][0]['PolicyNumber']);?>" readonly="readonly"/>
                        ...
                        <tr>
                            ...
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmenttransactionNumber" id="editamendmenttransactionNumber"  value="<?php echo trim($fetchData['submissionRow'][0]['TransactionNumber']);?>" readonly="readonly"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="12%">NAIC Code</td>
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentnaicCode" id="editamendmentnaicCode" value="<?php echo trim($fetchData['submissionRow'][0]['NAICCode']);?>" readonly="readonly"/>
                            </td>
                            <td width="12%">NAIC Title</td>
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentnaicTitle" id="editamendmentnaicTitle" value="<?php echo trim($fetchData['submissionRow'][0]['NAICTitle']);?>" readonly="readonly"/>
                            </td>
                            <td width="12%">SIC Code</td>
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentsicCode" id="editamendmentsicCode" value="<?php echo trim($fetchData['submissionRow'][0]['SICCode']);?>" maxlength="4" />
                            </td>
                        </tr>
                        <tr>
                            <td width="12%">SIC Title</td>
                            <td width="22%">
                                <input type="text" class="txtbox-small" name="editamendmentsicTitle" id="editamendmentsicTitle" value="<?php echo trim($fetchData['submissionRow'][0]['SICTitle']);?>"/>
                            </td>
