...
<div id="content">
    <div class="breadcrumbs group"> 
        <ul id="breadcrumb">
            ...
            <li class="selected">Submission Listing</li>
        </ul>
    ...
    <div class="container">
        <div class="box">
            ...
            <!--Filter Section-->
            <div class="content">
                <form method="POST" action="/submission/List" name="submissionFrm" id="submissionFrm">	
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <select name="newrenewal" class="listbox-small">
                                    ...
                                    foreach ($nerrenewal as $newRenewalvalue) {
                                        if ($newRenewalvalue['LookupName'] == $niddle['NewRenewal'])
                                            ...
                                            $select = '';
                                        ?>
                                        <option value="<?php echo $newRenewalvalue['Alias']; ?>" <?php echo $select; ?> ><?php echo $newRenewalvalue['Alias']; ?> </option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td>Create Date Range</td>
                            <td width="15%">
                            ...
                            <td>
                                <select name="Underwriter" id="Underwriter" class="listbox-small">
                                    ...
                                    foreach ($underWriter as $value) {
                                        if ($value->Name == $niddle['UnderwriterName'])
                                            $select = 'selected="selected"';
                                        else
                                            $select = '';
                                        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" autocomplete="off" readonly="true" value="<?php echo $niddle['EffectiveFromDate']; ?>" id="EffectiveFromDate" name="EffectiveFromDate" class="txtbox-small  width69 from" placeholder="From Date" />
                            ...
                            <td>
                                <input type="text" autocomplete="off" readonly="true" value="<?php echo $niddle['ExpirationFromDate']; ?>" id="ExpirationFromDate" name="ExpirationFromDate" class="txtbox-small  width69 from" placeholder="From Date" />
                        ...
                        <tr>
                            <td>QC Status</td>
                            <td>
                                <select name="qcstatus" class="listbox-small">
                                    <option value="">--Select--</option>
                                    <?php
                                    foreach ($qcStatus as $qcstatusvalue) {
                                        if ($qcstatusvalue['LookupName'] == $niddle['QcStatus'])
                                            $select = 'selected="selected"';
                                        else
                                            $select = '';
                                        ?>
                                        <option value="<?php echo $qcstatusvalue['Alias']; ?>" <?php echo $select; ?> ><?php echo $qcstatusvalue['Alias']; ?> </option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td>DBA Name</td>
                            <td>
                                <input name="DbaName" value="<?php echo $niddle['DbaName']; ?>" id="DbaName" type="text" class="txtbox-small" />
                            </td>
                        ...
                        <tr>
                            <td colspan="8" align="center">
                                <input type="submit" value="Search" class="btn btn-blue"  name="filterSubmit" id="filterSubmit" value="Search" />
                                <input type="reset" value="Clear" id="resetValue" class="btn btn-cyan" />
                            </td>
                        </tr>
                    </table>
                </form>
    ...
    <!--Filter Section-->
        <div class="container">
        <h2 class="dataTable-title">Submission List</h2>
        <div class="actn-btns">
            <div class="g1">
                <a href="/submission/createSubmission"><input type="button" class="btn btn-blue btn-medium" value="Create New Submission" /></a>
               <?php if ($numberofResults) { ?>
                <input type="button" class="btn btn-blue btn-medium export" value="Export" onclick="window.location = '/submission/ExportFile'" />
               <?php } ?>
            </div>
        <div class="g2">
        ...
        <div  id="submission-list-wrapper">
            <table class="dataTable sort">
                <thead>
                    <tr>
                        <th>Action</th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=0 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=0 & order=DESC"?>" class="down"></a>QC Status</div></th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=1 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=1 & order=DESC"?>" class="down"></a>Submission Number</div></th>
                        <th>Master Policy Number</th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=2 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=2 & order=DESC"?>" class="down"></a>New/Renewal</div></th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=3 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=3 & order=DESC"?>" class="down"></a>Insured Name<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=4 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=4 & order=DESC"?>" class="down"></a>Underwriter</div></th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=5 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=5 & order=DESC"?>" class="down"></a>Product Line<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=6 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=6 & order=DESC"?>" class="down"></a>Current Status<span class="plus-icon"></span></div></th>
                        <th class="current-status-expand hidden">Reason Code</th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=7 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=7 & order=DESC"?>" class="down"></a>Effective Date<span class="plus-icon"></div></span></th>
                        <th class="effective-date-expand hidden">Expiry Date</th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=8 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=8 & order=DESC"?>" class="down"></a>Branch Office</div></th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=9 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=9 & order=DESC"?>" class="down"></a>Broker Name<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=10 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=10 & order=DESC"?>" class="down"></a>Priority Companies</div></th>
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=11 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=11 & order=DESC"?>" class="down"></a>Premium (in USD)<span class="plus-icon"></span><div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=12 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=12 & order=DESC"?>" class="down"></a>Project Name<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=13 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=13 & order=DESC"?>" class="down"></a>Total Insured Value(TIV)<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=14 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=14 & order=DESC"?>" class="down"></a>Process Date<span class="plus-icon"></span></div></th>
                        ...
                        <th><div><a href="<?php echo "/submission/List" ." ?sort=15 & order=ASC"?>" class="up"></a><a href="<?php echo "/submission/List" ." ?sort=15 & order=DESC"?>" class="down"></a>Date of Receiving -By India From Berk SI<span class="plus-icon"></span></div></th>
                ...
                <tbody>
                    ...
                    if ($numberofResults) {
                        foreach ($arrData->getResults() as $value) {
                            ...
                            <tr>
                                <td>
                                    <?php $count = $value->getAmendmentCount(); $cancelCount = $value->getAmendmentCountCancelation(); if((empty($count) || $sf_user->hasCredential('EDIT_BOUND_SUBMISSION')) && empty($cancelCount)) { ?>
                                      <a class="btn btn-orange btn-small" title="Edit" href=<?php echo "/submission/edit?submission=" . $value->getId(); ?>><i class="fa fa-pencil"></i></a>
                                    <?php $cancelCount = $value->getAmendmentCountCancelation(); } else if(!empty($cancelCount) && $flag == 'master') {?>
                                      <a class="btn btn-orange btn-small" title="Edit" href=<?php echo "/submission/edit?submission=" . $value->getId(); ?>><i class="fa fa-pencil"></i></a>
                                    <?php } else { ?>
                                      <a class="btn btn-red btn-small editDisable"  title="Edit" href="#"><i class="fa fa-pencil"></i></a>
                                    <?php }?>
                                    <a class="btn btn-green btn-small" title="View" href=<?php echo "/submission/view?submission=" . $value->getId(); ?>><i class="fa fa-eye"></i></a>
                                    <?php if($sf_user->hasCredential('VIEW_EDIT_AMENDMENTSUBMISSION')) { ?>
                                        <?php $cancelCount = $value->getAmendmentCountCancelation();  if(($value->getCurrentstatus() == 'Bound' &&$value->getQcstatus() == 'Approved') && empty($cancelCount)) { ?>
                                            <a class="btn btn-endorsement btn-small" title="Amendment" href=<?php echo "/submission/amendment?amendment=" . $value->getId(); ?>><i class="fa fa-pencil-square-o"></i></a>
                                            <?php $count = $value->getAmendmentCount(); if(!empty($count)) { ?>
                                               <button class="btn btn-small btn-gray open fa fa-plus" id="<?php echo $value->getId();?>"></button>
                                            <?php } ?>
                                        <?php $cancelCount = $value->getAmendmentCountCancelation(); }else if(!empty($cancelCount) && $flag == 'master') {?>
                                               <a class="btn btn-endorsement btn-small" title="Amendment" href=<?php echo "/submission/amendment?amendment=" . $value->getId(); ?>><i class="fa fa-pencil-square-o"></i></a>
                                            <?php $count = $value->getAmendmentCount(); if(!empty($count)) { ?>
                                            ...
                                            <?php } ?>
                                        <?php $cancelCount = $value->getAmendmentCountCancelation(); }else if(!empty($cancelCount) && $flag != 'master') { ?>
                                               <a class="btn btn-red btn-small amendmentDisable" title="Amendment" href="#"><i class="fa fa-pencil-square-o"></i></a>
                                               <?php $count = $value->getAmendmentCount(); if(!empty($count)) { ?>
                                               <button class="btn btn-small btn-gray open fa fa-plus" id="<?php echo $value->getId();?>" value="<?php echo $value->getAmendmentCountCancelation(); ?>"></button>
                                               <?php } ?>
                                        <?php } ?>
                                     <?php }?>
                                </td>
                                <?php $status = $value->getQcstatus(); if($status == 'Pending') { ?>
                                <td class="pending"><?php echo $value->getQcstatus(); ?></td>
                                <?php } else if($status == 'Approved') { ?>
                                 <td class="approved"><?php echo $value->getQcstatus(); ?></td>
                                <?php } else if($status == 'Rejected') { ?>
                                  <td class="rejected"><?php echo $value->getQcstatus(); ?></td>
                                <?php } else{ ?>
                                  <td class="uncleared"><?php echo $value->getQcstatus(); ?></td>
                                <?php } ?>
                                <td><?php echo $value->getSubmissionnumber(); ?></td>
                                <td><?php echo $value->getMasterpolicynumber(); ?></td>
                                ...
                                <td class="insured-name-expand hidden"><?php echo $value->getInsuredcontactperson(); ?></td>
                                ...
                                <td><?php echo $value->getGrosspremiuminusd(); ?></td>
                                ...
                                <td class="gross-premium-expand hidden"><?php echo $value->getGrosspremium(); ?></td>
                                <td class="gross-premium-expand hidden"><?php echo $value->getLimitinusd(); ?></td>
                                <td class="gross-premium-expand hidden"><?php echo $value->getStatuslimit(); ?></td>
                                <td class="gross-premium-expand hidden"><?php echo $value->getAttachmentpointinusd(); ?></td>
                                <td class="gross-premium-expand hidden"><?php echo $value->getAttachmentpoint(); ?></td>
                                ...
                                <td class="policyCommissionPercentage-expand hidden"><?php echo $value->getPermiumnetofcomminusd(); ?></td> 
                                <td class="policyCommissionPercentage-expand hidden"><?php echo $value->getPermiumnetofcomminlocalcurrency(); ?></td> 
                                ...
                                <td><?php echo $value->getTotalinsuredvalue(); ?></td>
                                <td class="TIV-expand hidden"><?php echo $value->getTotalinsuredvalueinusd();?></td>
                                <td class="TIV-expand hidden"><?php echo $value->getAlternativezipcode();?></td>
                                <td class="TIV-expand hidden"><?php echo $value->getAlternativestate();?></td>
                                ...
                                <td class="ProcessDate-expand hidden"><?php $binddate = $value->getBinddate(); if(!empty($binddate)){ echo date('M-d-Y', strtotime($value->getBinddate()));}else {echo "";}?></td>
                                ...
                                <td class="companypaper-expand hidden"><?php $dateofRenewal = $value->getDateofrenewal(); if(!empty($dateofRenewal)) {echo date('M-d-Y', strtotime($value->getDateofrenewal()));}else {echo "";}?></td>
                                ...
                                <td class="policyType-expand hidden"><?php echo $value->getOfrcreport();?></td>
                                <td class="policyType-expand hidden"><?php echo $value->getTransactionnumber();?></td>
                                <td><?php $brokerDate= $value->getDateofrecievingbyindia();if(!empty($brokerDate)){ echo date('M-d-Y', strtotime($value->getDateofrecievingbyindia()));} else { echo "";} ?></td>
                                <td class="received-date-by-india-expand hidden"><?php $indiaDate = $value->getDateofrecievingbybroker(); if(!empty($indiaDate)){ echo date('M-d-Y h:i:s', strtotime($value->getDateofrecievingbybroker()));} else { echo "";} ?></td>
                            </tr>
    ...
    <?php if ($arrData->haveToPaginate()): ?>
        ...
        <ul class="pagination">
            ...
            <?php foreach ($arrData->getLinks() as $page): ?>
                ...
                <?php else: ?>
                    <?php echo '<li><a href="?page=' . $page . '&niddle=true" class="pagination-link" id="page-' . $page . '">' . $page . '</a></li>'; ?>
                <?php endif; ?>
            <?php endforeach; ?>
