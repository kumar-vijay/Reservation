 <div id="content" class="view">
    ...
    <div class="container">
        ...
        <div class="dates">
            <em>Created Date: <strong><?php if (!empty($result[0]['CreatedOn'])) {
              echo date("Y-m-d", strtotime($result[0]['CreatedOn']));
                } else {
                    echo "";
                } ?></strong></em>
            <em>Updated Date: <strong><?php if (!empty($result[0]['ModifiedOn'])) {
            ...
            <div class="content" style="display: block;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (!empty($result[0]['EffectiveDate'])) {
                        ...
                        <td>Expiry Date:</td>
                        <td>
                            <?php if (!empty($result[0]['ExpiryDate'])) {
                    ...
                    <tr>
                        ...
                        <td><?php if(!empty($result[0]['ExchangeRate'])) { echo $result[0]['ExchangeRate'];} else { echo "";} ?></td>
                        <td width="12%">Exchange Rate as on:</td>
                        <td width= "22%">
                            <?php if (!empty($result[0]['ExchangeDate'])) {
                        ...
                        <td colspan="2" rowspan="6" style="padding:5px;">
                            <table width="75%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    ...
                                    <td><?php if(!empty($result[0]['InsuredSubmissionDate']) && $result[0]['InsuredSubmissionDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("M-d-Y", strtotime($result[0]['InsuredSubmissionDate']));} elseif($result[0]['InsuredSubmissionDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";} else { echo "";} ?></td>
                                </tr>
                                <tr>
                                    <td>Insured Quote Due Date:</td>
                                    <td><?php if(!empty($result[0]['InsuredQuoteDueDate']) && $result[0]['InsuredQuoteDueDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("M-d-Y", strtotime($result[0]['InsuredQuoteDueDate']));} elseif($result[0]['InsuredQuoteDueDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";} else { echo "";} ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <div class="content" style="display: block;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><?php if(!empty($result[0]['TotalInsuredValue'])) { echo $result[0]['TotalInsuredValue'];} else { echo "";} ?></td>
                    </tr>
                    <tr>
            ...
            <div class="content" style="display: block;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width= "22%">
                            <?php if (!empty($result[0]['ProcessDate'])) {
            ...
            <div class="content" style="display: block;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><?php if(!empty($result[0]['PremiumInLocalCurrency'])) { 
                        ...
                        <td><?php if(!empty($result[0]['PremiumInUSD'])) { echo $result[0]['PremiumInUSD'];} else { echo "";} ?></td>
                    ...
                    <tr>
                        ...
                        <td width="22%"><?php if(!empty($result[0]['LimitInUSD'])) { echo $result[0]['LimitInUSD'];} else { echo "";} ?></td>
                        ...
                        <td><?php if(!empty($result[0]['AttachmentPointInUSD'])) { echo $result[0]['AttachmentPointInUSD'];} else { echo "";} ?></td>
                    </tr>
                    <tr>
            ...
            <div class="content" style="display: block;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td>Bind Date:</td>
                        <td>
                            <?php $validDate = date('Y-m-d', strtotime('-10 years')); if (!empty($result[0]['BindDate']) && date('Y-m-d', strtotime($result[0]['BindDate'])) >$validDate) {
                        ...
                        <td><?php if (!empty($result[0]['DateofRenewal'])) {
            ...
            <div class="content" style="display: block;">
                <table>
                    <tr>
                        ...
                        <td width="22%">
                            <?php if (!empty($result[0]['BerkSIDateFromBroker'])) {
                        ...
                        <td width="22%">
                            <?php if (!empty($result[0]['BerkSiDateFromIndia'])) {
                    ...
                    <tr>
                        ...
                        <td><?php echo $result[0]['Remark']; ?></td>
                    </tr>
                </table>
            </div>
        </div>
