...
$cabcomps = explode(" &amp; ",$submissionRow['CABCompaniesLookupId']);
?>
<div id="content">
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="22%">
                                <div style="position: relative;">
                                    <input type="text" name="editinsuredname" id="editinsuredname"  value="<?php echo trim($insuredName); ?>" class="txtbox-small"/>
                            ...
                            <td colspan="2" rowspan="6" style="padding:5px;">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="dba_table_data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="editinsuredContactPersonEmail" name="editinsuredContactPersonEmail" value="<?php echo $insuredContactPersonDetails['Email']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Contact Person's Number(O)</td>
                                        <td> 
                                            <input type="text" id="editinsuredContactPersonNumber" name="editinsuredContactPersonNumber" value="<?php echo $insuredContactPersonDetails['PhoneNumber']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Contact Person's Mobile</td>
                                        <td> 
                                            <input type="text" id="editinsuredContactPersonMobile" name="editinsuredContactPersonMobile" value="<?php echo $insuredContactPersonDetails['MobileNumber']; ?>" class="listbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Submission Date</td>
                                        <td> <input type="text" name="editinsuredSubmissionDate" id='editinsuredSubmissionDate' value="<?php if(!empty($submissionRow['InsuredSubmissionDate']) && $submissionRow['InsuredSubmissionDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("m/d/Y", strtotime($submissionRow['InsuredSubmissionDate']));} elseif($submissionRow['InsuredSubmissionDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";} else {echo "";} ?>" class="txtbox-small mailingaddress" readonly="readonly"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Insured Quote Due Date</td>
                                        <td> 
                                            <input type="text" name="editinsuredQuoteDueDate" id="editinsuredQuoteDueDate" value="<?php if(!empty($submissionRow['InsuredQuoteDueDate']) && $submissionRow['InsuredQuoteDueDate'] != 'Jan  1 1900 12:00:00:000AM'){ echo date("m/d/Y", strtotime($submissionRow['InsuredQuoteDueDate']));} elseif($submissionRow['InsuredQuoteDueDate'] == 'Jan  1 1900 12:00:00:000AM') { echo "";}else {echo "";}  ?>" class="txtbox-small mailingaddress" readonly="readonly" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="insured_address" id="insured_address" value="<?php echo $insuredaddress; ?>" class="txtbox-small" readonly="readonly"/>
                            </td>
                            <td>DBA Name</td>
                        ...
                        <tr>
                            <td>Country</td>
                            <td> 
                                <input type="text" name="insured_country" id="insured_country" class="txtbox-small" value="<?php echo $insuredCountry; ?>" readonly="readonly"/>
                            </td>
                            <td width="12%">D&amp;B Number</td>
                            <td width="22%"><input type="text" name="db_number" id="db_number" value="<?php echo $insuredDBNumber; ?>" class="txtbox-small" readonly="readonly"/></td>
                        </tr>
                        <tr>
                            <td>State</td>
                            <td> 
                                <input type="text" name="insured_state" id="insured_state" class="txtbox-small" value="<?php echo $insuredState; ?>" readonly="readonly" />
                            </td>
                            <td>Priority Companies<span style="color: red;"> *</span></td>
                            <td> 
                                <div class="dropdown divdropdown">
                                    <input readonly="readonly" type='text' name="cabValue" class='selectboxClass' id="cabValue" value="<?php echo str_replace(","," & ",$submissionRow['CABCompaniesLookupId']); ?>" style="font-size:8pt; width:130px; padding-right: 20px;" />
                                    <ul class="dropdown-list">                                    
                                        ...
                                        <?php
                                            foreach ($cabCompanies as $value) {
                                                 if (in_array($value['Alias'] ,$cabcomps))
                                                    $select = 'checked="checked"';
                                                else
                                                    $select = '';
                                        ?>
                                            <li>
                                                <label><input class="checkCabVal" type="checkbox"  <?php echo $select; ?> value="<?php echo $value['Alias']; ?>" name="editcabcompanies[]" /><?php echo $value['Alias']; ?></label>
                                            </li>
                                    <?php } ?>
                                    </ul>
                                </div>
                        ...
                        <tr>
                            <td>City</td>
                            <td> 
                                <input type="text" name="insured_city" id="insured_city" class="listbox-small" value="<?php echo $insuredCity; ?>" readonly="readonly" />
                            </td>
                        ...
                        <tr>
                            <td>Zipcode</td>
                            <td><input type="text" name="insured_zipcode" id="insured_zipcode" class="listbox-small" value="<?php echo $insuredZipcode; ?>" readonly="readonly"/></td>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td>ISO Code</td>
                            <td>
                                <input type="text" name="editisccode" id="editisccode" class="txtbox-small" value="<?php if($iscCode[0]['ISOCGL'] == 'NULL'){echo "";} else {echo $iscCode[0]['ISOCGL'];} ?>" disabled readonly/>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="content" style="display: block;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            ...
                            <td width="22%"> 
                                <select name="editclassName" id="editclassName" class="listbox-small" disabled>
                                    <option value="0">--Select--</option>
                                     <?php foreach ($classname as $value) { ?>
                            ...
                            <td width="22%"> 
                                <input type="text" class="txtbox-small ui-autocomplete-input" value="<?php echo $boundData['ClassCode']; ?>" id="editsubClass" name="editsubClass" disabled="disabled" autocomplete="off" maxlength="5">
                            </td>
                            <td width="12%">Description</td>
                            <td width="22%"> 
                                <input type="text" readonly="readonly" name="editdescription" id="editdescription" value="<?php echo $boundData['ClassDescription']; ?>" />
                            </td>
                        </tr>
                    ...
                    <table>
                        <tr>
                            ...
                            <td width="3%"><input type="checkbox" name= "yesBroker" id="yesBroker" value="Y" <?php
                                    ...
                                    ?>/></td>
                            <td width="18%"><input type="text" name="received_date_by_berkshire" class="date listbox-small" value="<?php if (!empty($submissionRow['byBerkSi']) && date('Y-m-d', strtotime($submissionRow['byBerkSi'])) != '1970-01-01' && date('Y-m-d', strtotime($submissionRow['byBerkSi'])) != '1900-01-01') {
                            ...
                            <td width="3%"><input type="checkbox" name= "yesIndia" id="yesIndia" value="Y" <?php
                                    ...
                                    ?>></td>
                            <td width="18%"><input type="text" name="received_date_by_india" class="date listbox-small" value="<?php if (!empty($submissionRow['byIndia']) && date('Y-m-d', strtotime($submissionRow['byIndia'])) != '1970-01-01' && date('Y-m-d', strtotime($submissionRow['byIndia'])) != '1900-01-01') {
                                    ...
                                    <select name="branch_office" id="branchid" class="listbox-small">
                                        <option value="">-- Select --</option>
                                           <?php foreach ($branch as $branchValue) { ?>
                                            ...
                                            <?php if ($branchValue['Id'] == $submissionRow['BranchId']) {
                                                echo "selected = selected";
