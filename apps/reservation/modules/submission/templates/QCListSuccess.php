...
<div id="content">
    <div class="breadcrumbs group"> 
        <ul id="breadcrumb">
            ...
            <li class="selected">Submission QC Queue List</li>
        </ul>
    ...
    <div class="container">
        <h2 class="dataTable-title">QC-Queue List</h2>
        <div class="actn-btns">
            <div class="g1">
               ...
               <?php if ($numberofResults) { ?>
                <!--input type="button" class="btn btn-blue btn-medium export" value="Export" onclick="window.location = '/submission/ExportQCFile'" /-->
               <?php } ?>
            </div>
            <div class="g2">
                ...
                <tbody>
                    ...
                    if ($numberofResults) {
                        foreach ($arrData->getResults() as $value) {
                            ?>
                            <tr>
                                <td><a class="btn btn-green btn-small" href=<?php echo "/submission/QCView?submission=" . $value->getId(); ?>><i class="fa fa-eye"></i></a></td>
                                ...
                                <td class="broker-name-expand hidden"><?php if($value->getBrokertype()=='R'){ echo "Retailer";}elseif ($value->getBrokertype()=='W') { echo "Wholesaler";} ?></td>
                                ...
                                <td class="gross-premium-expand hidden"><?php $exchangeDate = $value->getExchangedate(); if(!empty($exchangeDate)){ echo $value->getExchangedate();} else { echo "";} ?></td>
