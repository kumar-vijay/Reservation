<div id="content" class="view">
    <div class="breadcrumbs group"> 
        <ul id="breadcrumb">
            ...
            <li><a href="/submission/QCList">QC Queue</a><span> >>&nbsp; </span></li>
            <li class="selected">View</li>
        </ul>
        <a href="/submission/QCList" id="back"></a>
    </div> 
    <div class="container">
        <ul class="tabbed-menu">
            <li class="active"><a href=<?php echo "/submission/QCView?submission=" . $submissionId; ?>>Submission Details</a></li>
            <li><a href=<?php echo "/submission/viewHistory?submission=" . $submissionId; ?>>Submission History</a></li>
        </ul>	
        <div class="dates">
            <em>Created Date: <strong><?php if(!empty($result['CREATION_DATE'])){ echo date("M-d-Y", strtotime($result['CREATION_DATE']));} else { echo "";} ?></strong></em>
            <em>Updated Date: <strong><?php if(!empty($result['MODIFY_DATE'])){ echo  date("M-d-Y", strtotime($result['MODIFY_DATE']));} else { echo "";} ?></strong></em>
        </div>
        <div class="clear"></div>
    </div>
...
<div class="container">
    ...
    <form action="<?php echo "/submission/QCUpdate?submission=" . $submissionId; ?>" name="qcSubmitForm" id="qcSubmitForm" method="POST">
        <div class="container">
            <div class="box">
                ...
                <div class="content" style="display: block;">
                    <table>
                        <tr>
                            ...
                            <td width="18%"><textarea name="qcremarks"><?php echo $result['REMARK']; ?></textarea></td>
                        </tr>           
                    </table>
                </div>
            </div>
