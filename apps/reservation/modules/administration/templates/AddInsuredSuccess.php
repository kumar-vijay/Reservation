        ...
        <div class="container">
            <div class="box">
                ...
                <div class="content" style="display: block;">
                    <?php if (isset($errorArr)) {?><div class="grouperror"><?php foreach ($errorArr as $err => $val) { echo "<li>$val</li>"; } ?></div><?php } ?>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td colspan="6" align="center">
                        <input type="submit" value="Submit" class="btn btn-blue" id="insuredSubmit" name="insuredSubmit" />
                        <input type="reset" value="Cancel" onclick="location.href = '<?php echo url_for('@insured_list') ?>';" class="btn btn-cyan" />
                    </td>
                </tr>
            </table>
        </div>
