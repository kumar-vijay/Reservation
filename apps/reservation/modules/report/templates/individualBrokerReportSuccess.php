...
<div class="breadcrumbs group"> 
    <ul id="breadcrumb">
        ...
        <li class="selected">Individual Broker Report</li>
    </ul>
...
<div class="container">
    <div class="box">
        <h1 class="section-header">Individual Broker Report Details
            <div class="arrow"></div>
        </h1>
                    ...
                    <tr>
                        ...
                        <td width="22%">
                            <select name="brokername" id="brokername" class="listbox-small">
                                <option value="0">--Select--</option>
                                <?php foreach ($parameter[8]['ValidValues'] as $value) { 
                                     if ($value->Label == $niddle['BrokerName'])
                                        $select = 'selected="selected"';
                                    else
                                        $select = '';
                                ?>
...
<?php if($result){ ?>
        <div class="container">
            ...
            <form method="POST" action="/report/DownloadIndividualBrokerReport" name="IndividualBrokerReportForm" id="IndividualBrokerReportForm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
