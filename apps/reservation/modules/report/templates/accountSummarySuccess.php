...
<div class="container">
    <div class="box">
        <h1 class="section-header">Monthly Summary Details
            <div class="arrow"></div>
        </h1>
...
<?php if($result){ ?>
        <div class="container">
            ...
            <form method="POST" action="/report/DownloadAccountSummaryReport" name="AccountSummaryForm" id="AccountSummaryForm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
