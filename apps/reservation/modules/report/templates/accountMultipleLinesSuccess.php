...
<div class="breadcrumbs group"> 
    <ul id="breadcrumb">
        ...
        <li class="selected">Accounts on Multiple Lines</li>
    </ul>
...
<div class="container">
    <div class="box">
        <h1 class="section-header">Accounts on Multiple Lines Details
            <div class="arrow"></div>
        </h1>
        <div class="content" style="display: block;">
            ...
            ?>
            <form method="POST" action="" name="AccountsMultipleLinesForm" id="AccountsMultipleLinesForm">
...
<?php if($result){ ?>
        <div class="container">
            ...
            <form method="POST" action="/report/DownloadAccountMultipleLinesReport" name="AccountMultipleLinesForm" id="AccountMultipleLinesForm">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
