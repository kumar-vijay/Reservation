...
class UnderwriterPerformance {
    ...
    public function getReport($postArray) {
        define("REPORT", "/KPI Reports As Of Date/Underwriter_Performance");
    ...
    public function DownloadReport($postArray, $reportType) {
        ...
        try {
            ...
            if ($reportType == 'PDF') {
                ...
                header("Content-Disposition:attachment;filename='Underwriter-Performance.pdf'");
                ...
                header("Content-Disposition:attachment;filename='Underwriter-Performance.csv'");
                header("Content-length: " . (string) (strlen($result)));
                header("Expires: " . gmdate("D, d M Y H:i:s", mktime(date("H") + 2, date("i"), date("s"), date("m"), date("d"), date("Y"))) . " GMT");
                header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
                header("Cache-Control: no-cache, must-revalidate");
                ...
                header("Content-Disposition:attachment;filename=Underwriter-Performance.xls");
                header("Content-length: " . (string) (strlen($result)));
                header("Expires: " . gmdate("D, d M Y H:i:s", mktime(date("H") + 2, date("i"), date("s"), date("m"), date("d"), date("Y"))) . " GMT");
                header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
                header("Cache-Control: no-cache, must-revalidate");
                ...
                header("Content-Disposition:attachment;filename='Underwriter-Performance.doc'");
                header("Content-length: " . (string) (strlen($result)));
                header("Expires: " . gmdate("D, d M Y H:i:s", mktime(date("H") + 2, date("i"), date("s"), date("m"), date("d"), date("Y"))) . " GMT");
                header("Last-Modified: " . gmdate("D, d M Y H:i:s") . " GMT");
                header("Cache-Control: no-cache, must-revalidate");
