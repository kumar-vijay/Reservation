...
abstract class BaseBranchPeer {
	...
	/** the column name for the CITYCODEID field */
	const CITYCODEID = 'Branch.CITYCODEID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Branch', 'Citycodeid', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'branch', 'citycodeid', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::BRANCH, self::CITYCODEID, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'Branch', 'CityCodeId', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Branch' => 1, 'Citycodeid' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'branch' => 1, 'citycodeid' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::BRANCH => 1, self::CITYCODEID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'Branch' => 1, 'CityCodeId' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BranchPeer::BRANCH);
		$criteria->addSelectColumn(BranchPeer::CITYCODEID);
	}
	...
	public static function doCountJoinCity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(BranchPeer::CITYCODEID, CityPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Branch objects pre-filled with their City objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Branch) to $obj2 (City)
				$obj2->addBranch($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Branch) to the collection in $obj2 (City)
				$obj2->addBranch($obj1);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseBranchPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseBranchPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseBranchPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseBranchPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseBranchPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseBranchPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseBranchPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseBranchPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += BranchPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(UnderwriterPeer::BRANCHID, $obj->getId());
