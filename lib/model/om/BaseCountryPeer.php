...
abstract class BaseCountryPeer {
	...
	/** the column name for the INSURED'S COUNTRY field */
	const INSUREDCOUNTRY = 'Country.INSUREDCOUNTRY';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Insuredcountry', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'insuredcountry', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::INSUREDCOUNTRY, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'InsuredCountry', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Insuredcountry' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'insuredcountry' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::INSUREDCOUNTRY => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'InsuredCountry' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryPeer::INSUREDCOUNTRY);
	}
	...
	{
		// invalidate objects in StatePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CountryPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(StatePeer::COUNTRYID, $obj->getId());
