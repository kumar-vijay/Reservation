...
abstract class BaseDocuments extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the remove_flag field.
	 * @var        string
	 */
	protected $remove_flag;
	...
	/**
	 * Get the [document_type] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [remove_flag] column value.
	 * 
	 * @return     string
	 */
	...
	public function setDocumentId($v)
	{
		...
		if ($this->document_id !== $v) {
			$this->document_id = $v;
			$this->modifiedColumns[] = DocumentsPeer::DOCUMENT_ID;
		}
	...
	public function setSubmissionId($v)
	{
		...
		if ($this->submission_id !== $v) {
			...
			$this->modifiedColumns[] = DocumentsPeer::SUBMISSION_ID;
		}
	...
	public function setUserId($v)
	{
		...
		if ($this->user_id !== $v) {
			$this->user_id = $v;
			$this->modifiedColumns[] = DocumentsPeer::USER_ID;
		}
	...
	public function setFileName($v)
	{
		...
		if ($this->file_name !== $v) {
			$this->file_name = $v;
			$this->modifiedColumns[] = DocumentsPeer::FILE_NAME;
		}
	...
	public function setFilePath($v)
	{
		...
		if ($this->file_path !== $v) {
			$this->file_path = $v;
			$this->modifiedColumns[] = DocumentsPeer::FILE_PATH;
		}
	...
	/**
	 * Set the value of [document_type] column.
	 * 
	 * @param      string $v new value
	 * @return     Documents The current object (for fluent API support)
	 */
	public function setDocumentType($v)
	{
		...
		if ($this->document_type !== $v) {
			$this->document_type = $v;
			$this->modifiedColumns[] = DocumentsPeer::DOCUMENT_TYPE;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DocumentsPeer::CREATED_ON;
			}
	...
	public function setModifiedOn($v)
	{
		...
		if ( $this->modified_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = DocumentsPeer::MODIFIED_ON;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [remove_flag] column.
	 * 
	 * @param      string $v new value
	 * @return     Documents The current object (for fluent API support)
	 */
	public function setRemoveFlag($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->remove_flag !== $v) {
			$this->remove_flag = $v;
			$this->modifiedColumns[] = DocumentsPeer::REMOVE_FLAG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->document_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->file_path = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->document_type = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->created_on = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->modified_on = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->remove_flag = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setDocumentId($pk);  //[IMV] update autoincrement primary key
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[5] => $this->getDocumentType(),
			$keys[6] => $this->getCreatedOn(),
			$keys[7] => $this->getModifiedOn(),
			$keys[8] => $this->getRemoveFlag(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setDocumentId($arr[$keys[0]]);
		...
		if (array_key_exists($keys[5], $arr)) $this->setDocumentType($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setCreatedOn($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setModifiedOn($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setRemoveFlag($arr[$keys[8]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DocumentsPeer::DOCUMENT_ID)) $criteria->add(DocumentsPeer::DOCUMENT_ID, $this->document_id);
		if ($this->isColumnModified(DocumentsPeer::SUBMISSION_ID)) $criteria->add(DocumentsPeer::SUBMISSION_ID, $this->submission_id);
		if ($this->isColumnModified(DocumentsPeer::USER_ID)) $criteria->add(DocumentsPeer::USER_ID, $this->user_id);
		if ($this->isColumnModified(DocumentsPeer::FILE_NAME)) $criteria->add(DocumentsPeer::FILE_NAME, $this->file_name);
		if ($this->isColumnModified(DocumentsPeer::FILE_PATH)) $criteria->add(DocumentsPeer::FILE_PATH, $this->file_path);
		if ($this->isColumnModified(DocumentsPeer::DOCUMENT_TYPE)) $criteria->add(DocumentsPeer::DOCUMENT_TYPE, $this->document_type);
		if ($this->isColumnModified(DocumentsPeer::CREATED_ON)) $criteria->add(DocumentsPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(DocumentsPeer::MODIFIED_ON)) $criteria->add(DocumentsPeer::MODIFIED_ON, $this->modified_on);
		if ($this->isColumnModified(DocumentsPeer::REMOVE_FLAG)) $criteria->add(DocumentsPeer::REMOVE_FLAG, $this->remove_flag);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DocumentsPeer::DOCUMENT_ID, $this->document_id);
	...
	/**
	 * Generic method to set the primary key (document_id column).
	 *
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setDocumentType($this->document_type);

		$copyObj->setCreatedOn($this->created_on);

		$copyObj->setModifiedOn($this->modified_on);

		$copyObj->setRemoveFlag($this->remove_flag);
