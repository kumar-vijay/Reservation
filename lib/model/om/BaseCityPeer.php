...
abstract class BaseCityPeer {
	...
	/** the column name for the CITYFULLCODE field */
	const CITYFULLCODE = 'City.CITYFULLCODE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'City', 'State', 'Citycode', 'Cityfullcode', 'Statecode', 'Stateid', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'city', 'state', 'citycode', 'cityfullcode', 'statecode', 'stateid', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CITY, self::STATE, self::CITYCODE, self::CITYFULLCODE, self::STATECODE, self::STATEID, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'City', 'State', 'CityCode', 'CityFullCode', 'StateCode', 'StateId', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'City' => 1, 'State' => 2, 'Citycode' => 3, 'Cityfullcode' => 4, 'Statecode' => 5, 'Stateid' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'city' => 1, 'state' => 2, 'citycode' => 3, 'cityfullcode' => 4, 'statecode' => 5, 'stateid' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CITY => 1, self::STATE => 2, self::CITYCODE => 3, self::CITYFULLCODE => 4, self::STATECODE => 5, self::STATEID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'City' => 1, 'State' => 2, 'CityCode' => 3, 'CityFullCode' => 4, 'StateCode' => 5, 'StateId' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CityPeer::STATE);
		$criteria->addSelectColumn(CityPeer::CITYCODE);
		$criteria->addSelectColumn(CityPeer::CITYFULLCODE);
		$criteria->addSelectColumn(CityPeer::STATECODE);
		$criteria->addSelectColumn(CityPeer::STATEID);
	}
	...
	{
		// invalidate objects in BranchPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		...
		// invalidate objects in InsuredPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	/**
	 * Returns the number of rows matching criteria, joining the related StateRelatedByStateid table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinStateRelatedByStateid(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CityPeer::STATEID, StatePeer::ID, $join_behavior);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinStateRelatedByStateid(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCityPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCityPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCityPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCityPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCityPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCityPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCityPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCityPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += CityPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(BranchPeer::CITYCODEID, $obj->getId());
			...
			$criteria->add(BrokerwisecityPeer::CITYID, $obj->getId());
			...
			$criteria->add(InsuredPeer::CITYID, $obj->getId());
			$affectedRows += InsuredPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
