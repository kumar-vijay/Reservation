...
abstract class BaseCountry extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the insured's country field.
	 * @var        string
	 */
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collStates.
	 */
	...
	/**
	 * Get the [insured's country] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [insured's country] column.
	 * 
	...
	public function setInsuredcountry($v)
	{
		...
		if ($this->insuredcountry !== $v) {
			...
			$this->modifiedColumns[] = CountryPeer::INSUREDCOUNTRY;
		}

		return $this;
	} // setInsured's country()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->insuredcountry = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->resetModified();
			...
			return $startcol + 2; // 2 = CountryPeer::NUM_COLUMNS - CountryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setInsuredcountry($arr[$keys[1]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CountryPeer::INSUREDCOUNTRY)) $criteria->add(CountryPeer::INSUREDCOUNTRY, $this->insuredcountry);
	...
	/**
	 * Clears out the collStates collection (array).
	 *
	...
	/**
	 * Initializes the collStates collection (array).
	 *
	 ...
	 * related States from storage. If this Country is new, it will return
		...
		if ($this->collStates === null) {
			if ($this->isNew()) {
			   $this->collStates = array();
				...
				$criteria->add(StatePeer::COUNTRYID, $this->id);
	...
	public function addState(State $l)
	{
		...
		if (!in_array($l, $this->collStates, true)) { // only add it if the **same** object is not already associated
			array_push($this->collStates, $l);
			$l->setCountry($this);
		}
	}
