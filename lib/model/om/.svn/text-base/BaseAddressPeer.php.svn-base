...
abstract class BaseAddressPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Addressline1', 'Addressline2', 'Cityid', 'Zip', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'addressline1', 'addressline2', 'cityid', 'zip', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ADDRESSLINE1, self::ADDRESSLINE2, self::CITYID, self::ZIP, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'AddressLine1', 'AddressLine2', 'CityId', 'Zip', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Addressline1' => 1, 'Addressline2' => 2, 'Cityid' => 3, 'Zip' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'addressline1' => 1, 'addressline2' => 2, 'cityid' => 3, 'zip' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ADDRESSLINE1 => 1, self::ADDRESSLINE2 => 2, self::CITYID => 3, self::ZIP => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'AddressLine1' => 1, 'AddressLine2' => 2, 'CityId' => 3, 'Zip' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(AddressPeer::ADDRESSLINE1);
		$criteria->addSelectColumn(AddressPeer::ADDRESSLINE2);
		$criteria->addSelectColumn(AddressPeer::CITYID);
		$criteria->addSelectColumn(AddressPeer::ZIP);
	}
	...
	public static function doCountJoinCity(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AddressPeer::CITYID, CityPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Address objects pre-filled with their City objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCity(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Address) to $obj2 (City)
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Address) to the collection in $obj2 (City)
				$obj2->addAddress($obj1);
