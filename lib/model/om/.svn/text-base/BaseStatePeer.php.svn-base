...
abstract class BaseStatePeer {
	...
	const ABREVIATION = 'State.ABREVIATION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Countryid', 'Statename', 'Code', 'Abreviation', 'Statecode', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'countryid', 'statename', 'code', 'abreviation', 'statecode', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::COUNTRYID, self::STATENAME, self::CODE, self::ABREVIATION, self::STATECODE, ),
		BasePeer::TYPE_FIELDNAME => array ('Id', 'CountryId', 'StateName', 'Code', 'Abreviation', 'StateCode', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Countryid' => 1, 'Statename' => 2, 'Code' => 3, 'Abreviation' => 4, 'Statecode' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'countryid' => 1, 'statename' => 2, 'code' => 3, 'abreviation' => 4, 'statecode' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COUNTRYID => 1, self::STATENAME => 2, self::CODE => 3, self::ABREVIATION => 4, self::STATECODE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('Id' => 0, 'CountryId' => 1, 'StateName' => 2, 'Code' => 3, 'Abreviation' => 4, 'StateCode' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(StatePeer::COUNTRYID);
		$criteria->addSelectColumn(StatePeer::STATENAME);
		$criteria->addSelectColumn(StatePeer::CODE);
		$criteria->addSelectColumn(StatePeer::ABREVIATION);
		$criteria->addSelectColumn(StatePeer::STATECODE);
	}
	...
	{
		// invalidate objects in CityPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doCountJoinCountry(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(StatePeer::COUNTRYID, CountryPeer::ID, $join_behavior);
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseStatePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseStatePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseStatePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseStatePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseStatePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseStatePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseStatePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseStatePeer', $values, $con, $ret);
    }
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CityPeer::STATEID, $obj->getId());
