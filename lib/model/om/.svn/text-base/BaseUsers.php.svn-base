...
abstract class BaseUsers extends BaseObject  implements Persistent {
	...
	public function setEmailId($v)
	{
		...
		if ($this->email_id !== $v) {
			$this->email_id = $v;
			$this->modifiedColumns[] = UsersPeer::EMAIL_ID;
		}
	...
	public function setFirstname($v)
	{
		...
		if ($this->firstname !== $v) {
			$this->firstname = $v;
			$this->modifiedColumns[] = UsersPeer::FIRSTNAME;
		}
	...
	public function setLastname($v)
	{
		...
		if ($this->lastname !== $v) {
			$this->lastname = $v;
			$this->modifiedColumns[] = UsersPeer::LASTNAME;
		}
	...
	public function setUserStatus($v)
	{
		...
		if ($this->user_status !== $v) {
			$this->user_status = $v;
			$this->modifiedColumns[] = UsersPeer::USER_STATUS;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UsersPeer::CREATED_ON;
			}
	...
	public function setModifiedOn($v)
	{
		...
		if ( $this->modified_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UsersPeer::MODIFIED_ON;
			}
		} // if either are not null
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = UsersPeer::CREATED_BY_ID;
		}
	...
	public function setModifiedById($v)
	{
		...
		if ($this->modified_by_id !== $v) {
			...
			$this->modifiedColumns[] = UsersPeer::MODIFIED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->email_id = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			...
			$this->user_status = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->created_on = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->modified_on = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->created_by_id = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->modified_by_id = ($row[$startcol + 10] !== null) ? (int) $row[$startcol + 10] : null;
			$this->resetModified();
			...
			return $startcol + 11; // 11 = UsersPeer::NUM_COLUMNS - UsersPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[6] => $this->getUserStatus(),
			$keys[7] => $this->getCreatedOn(),
			$keys[8] => $this->getModifiedOn(),
			$keys[9] => $this->getCreatedById(),
			$keys[10] => $this->getModifiedById(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setUserStatus($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setCreatedOn($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setModifiedOn($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setCreatedById($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setModifiedById($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsersPeer::EMAIL_ID)) $criteria->add(UsersPeer::EMAIL_ID, $this->email_id);
		if ($this->isColumnModified(UsersPeer::FIRSTNAME)) $criteria->add(UsersPeer::FIRSTNAME, $this->firstname);
		if ($this->isColumnModified(UsersPeer::LASTNAME)) $criteria->add(UsersPeer::LASTNAME, $this->lastname);
		...
		if ($this->isColumnModified(UsersPeer::USER_STATUS)) $criteria->add(UsersPeer::USER_STATUS, $this->user_status);
		if ($this->isColumnModified(UsersPeer::CREATED_ON)) $criteria->add(UsersPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(UsersPeer::MODIFIED_ON)) $criteria->add(UsersPeer::MODIFIED_ON, $this->modified_on);
		if ($this->isColumnModified(UsersPeer::CREATED_BY_ID)) $criteria->add(UsersPeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(UsersPeer::MODIFIED_BY_ID)) $criteria->add(UsersPeer::MODIFIED_BY_ID, $this->modified_by_id);
