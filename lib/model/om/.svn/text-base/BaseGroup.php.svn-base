...
abstract class BaseGroup extends BaseObject  implements Persistent {
	...
	public function setGroupId($v)
	{
		...
		if ($this->group_id !== $v) {
			$this->group_id = $v;
			$this->modifiedColumns[] = GroupPeer::GROUP_ID;
		}
	...
	public function setGroupName($v)
	{
		...
		if ($this->group_name !== $v) {
			$this->group_name = $v;
			$this->modifiedColumns[] = GroupPeer::GROUP_NAME;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GroupPeer::CREATED_ON;
			}
	...
	public function setModifiedOn($v)
	{
		...
		if ( $this->modified_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GroupPeer::MODIFIED_ON;
			}
		} // if either are not null
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = GroupPeer::CREATED_BY_ID;
		}
	...
	public function setModifiedById($v)
	{
		...
		if ($this->modified_by_id !== $v) {
			...
			$this->modifiedColumns[] = GroupPeer::MODIFIED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = GroupPeer::NUM_COLUMNS - GroupPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GroupPeer::GROUP_ID)) $criteria->add(GroupPeer::GROUP_ID, $this->group_id);
		if ($this->isColumnModified(GroupPeer::GROUP_NAME)) $criteria->add(GroupPeer::GROUP_NAME, $this->group_name);
		if ($this->isColumnModified(GroupPeer::STATUS)) $criteria->add(GroupPeer::STATUS, $this->status);
		if ($this->isColumnModified(GroupPeer::CREATED_ON)) $criteria->add(GroupPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(GroupPeer::MODIFIED_ON)) $criteria->add(GroupPeer::MODIFIED_ON, $this->modified_on);
		if ($this->isColumnModified(GroupPeer::CREATED_BY_ID)) $criteria->add(GroupPeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(GroupPeer::MODIFIED_BY_ID)) $criteria->add(GroupPeer::MODIFIED_BY_ID, $this->modified_by_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GroupPeer::GROUP_ID, $this->group_id);
