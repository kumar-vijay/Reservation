...
abstract class BaseProductsPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Products';
	...
	const SUBMISSION_TYPE = 'PRODUCTS.SUBMISSION_TYPE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ProductId', 'ProductName', 'SubmissionType', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('productId', 'productName', 'submissionType', ),
		BasePeer::TYPE_COLNAME => array (self::PRODUCT_ID, self::PRODUCT_NAME, self::SUBMISSION_TYPE, ),
		BasePeer::TYPE_FIELDNAME => array ('PRODUCT_ID', 'PRODUCT_NAME', 'SUBMISSION_TYPE', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ProductId' => 0, 'ProductName' => 1, 'SubmissionType' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('productId' => 0, 'productName' => 1, 'submissionType' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::PRODUCT_ID => 0, self::PRODUCT_NAME => 1, self::SUBMISSION_TYPE => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('PRODUCT_ID' => 0, 'PRODUCT_NAME' => 1, 'SUBMISSION_TYPE' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		$criteria->addSelectColumn(ProductsPeer::PRODUCT_ID);
		$criteria->addSelectColumn(ProductsPeer::PRODUCT_NAME);
		$criteria->addSelectColumn(ProductsPeer::SUBMISSION_TYPE);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseProductsPeer', $criteria, $con);
		}
	 ...
	 */
	public static function addInstanceToPool(Products $obj, $key = null)
	{
	...
	/**
	 * Method perform an INSERT on the database, given a Products or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductsPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProductsPeer', $values, $con))
      {
		...
		if ($criteria->containsKey(ProductsPeer::PRODUCT_ID) && $criteria->keyContainsValue(ProductsPeer::PRODUCT_ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ProductsPeer::PRODUCT_ID.')');
		}
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductsPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProductsPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Products or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductsPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseProductsPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ProductsPeer::PRODUCT_ID);
			$selectCriteria->add(ProductsPeer::PRODUCT_ID, $criteria->remove(ProductsPeer::PRODUCT_ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseProductsPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseProductsPeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ProductsPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Products or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ProductsPeer::PRODUCT_ID, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Products $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ProductsPeer::PRODUCT_ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ProductsPeer::DATABASE_NAME);
			$criteria->add(ProductsPeer::PRODUCT_ID, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseProductsPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
