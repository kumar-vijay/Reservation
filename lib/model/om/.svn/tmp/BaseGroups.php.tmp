...
abstract class BaseGroups extends BaseObject  implements Persistent {
	...
	public function setGroupId($v)
	{
		...
		if ($this->group_id !== $v) {
			$this->group_id = $v;
			$this->modifiedColumns[] = GroupsPeer::GROUP_ID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = GroupsPeer::STATUS;
		}
	...
	public function setCreatedOn($v)
	{
		...
		if ( $this->created_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GroupsPeer::CREATED_ON;
			}
	...
	public function setModifiedOn($v)
	{
		...
		if ( $this->modified_on !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GroupsPeer::MODIFIED_ON;
			}
		} // if either are not null
	...
	public function setCreatedById($v)
	{
		...
		if ($this->created_by_id !== $v) {
			...
			$this->modifiedColumns[] = GroupsPeer::CREATED_BY_ID;
		}
	...
	public function setModifiedById($v)
	{
		...
		if ($this->modified_by_id !== $v) {
			...
			$this->modifiedColumns[] = GroupsPeer::MODIFIED_BY_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->modified_on = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->created_by_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			$this->modified_by_id = ($row[$startcol + 6] !== null) ? (int) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = GroupsPeer::NUM_COLUMNS - GroupsPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[4] => $this->getModifiedOn(),
			$keys[5] => $this->getCreatedById(),
			$keys[6] => $this->getModifiedById(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setModifiedOn($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setCreatedById($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setModifiedById($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GroupsPeer::GROUP_ID)) $criteria->add(GroupsPeer::GROUP_ID, $this->group_id);
		if ($this->isColumnModified(GroupsPeer::GROUP_NAME)) $criteria->add(GroupsPeer::GROUP_NAME, $this->group_name);
		if ($this->isColumnModified(GroupsPeer::STATUS)) $criteria->add(GroupsPeer::STATUS, $this->status);
		if ($this->isColumnModified(GroupsPeer::CREATED_ON)) $criteria->add(GroupsPeer::CREATED_ON, $this->created_on);
		if ($this->isColumnModified(GroupsPeer::MODIFIED_ON)) $criteria->add(GroupsPeer::MODIFIED_ON, $this->modified_on);
		if ($this->isColumnModified(GroupsPeer::CREATED_BY_ID)) $criteria->add(GroupsPeer::CREATED_BY_ID, $this->created_by_id);
		if ($this->isColumnModified(GroupsPeer::MODIFIED_BY_ID)) $criteria->add(GroupsPeer::MODIFIED_BY_ID, $this->modified_by_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(GroupsPeer::GROUP_ID, $this->group_id);
